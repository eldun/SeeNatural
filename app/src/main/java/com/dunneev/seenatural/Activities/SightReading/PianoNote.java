...
public enum PianoNote {
    ...
    D2("D2", 38, 24, -1, "[D2]"),
    D_SHARP_2("D♯2", 39, 25, 26, "[D♯2]-[Eb2]"),
    E_FLAT_2("E♭2", 39, 26, 25, "[D♯2]-[Eb2]"),
    E2("E2", 40, 27, -1, "[E2]"),
    F2("F2", 41, 28, -1, "[F2]"),
    ...
    D3("D3", 50, 41, -1, "[D3]"),
    D_SHARP_3("D♯3", 51, 42, 43, "[D♯3]-[Eb3]"),
    E_FLAT_3("E♭3", 51, 43, 42, "[D♯3]-[Eb3]"),
    E3("E3", 52, 44, -1, "[E3]"),
    F3("F3", 53, 45, -1, "[F3]"),
    ...
    D4("D4", 62, 58, -1, "[D4]"),
    D_SHARP_4("D♯4", 63, 59, 60, "[D♯4]-[Eb4]"),
    E_FLAT_4("E♭4", 63, 60, 59, "[D♯4]-[Eb4]"),
    E4("E4", 64, 61, -1, "[E4]"),
    F4("F4", 65, 62, -1, "[F4]"),
    ...
    D5("D5", 74, 75, -1, "[D5]"),
    D_SHARP_5("D♯5", 75, 76, 77, "[D♯5]-[Eb5]"),
    E_FLAT_5("E♭5", 75, 77, 76, "[D♯5]-[Eb5]"),
    E5("E5", 76, 78, -1, "[E5]"),
    F5("F5", 77, 79, -1, "[F5]"),
    ...
    D6("D6", 86, 92, -1, "[D6]"),
    D_SHARP_6("D♯6", 87, 93, 94, "[D♯6]-[Eb6]"),
    E_FLAT_6("E♭6", 87, 94, 93, "[D♯6]-[Eb6]"),
    E6("E6", 88, 95, -1, "[E6]"),
    F6("F6", 89, 96, -1, "[F6]"),
    ...
    D7("D7", 98, 109, -1, "[D7]"),
    D_SHARP_7("D♯7", 99, 110, 111, "[D♯7]-[Eb7]"),
    E_FLAT_7("E♭7", 99, 111, 110, "[D♯7]-[Eb7]"),
    E7("E7", 100, 112, -1, "[E7]"),
    F7("F7", 101, 113, -1, "[F7]"),
